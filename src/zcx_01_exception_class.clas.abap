class ZCX_01_EXCEPTION_CLASS definition
  public
...
public section.
  ...
  constants:
    begin of ZCX_01_EXCEPTION_CLASS,
      msgid type symsgid value 'Z01_MSGCLASS',
      msgno type symsgno value '000',
      attr1 type scx_attrname value '',
      attr2 type scx_attrname value '',
      attr3 type scx_attrname value '',
      attr4 type scx_attrname value '',
    end of ZCX_01_EXCEPTION_CLASS .
...
CLASS ZCX_01_EXCEPTION_CLASS IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = ZCX_01_EXCEPTION_CLASS .
else.
